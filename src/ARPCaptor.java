...
public class ARPCaptor {
	public static void main(String[] args) throws Exception {  
        ...
        System.out.println("Start teim:" + new Date());  
        openDevice();  
        showAdapterInfo();  
        setFilter(3);  
        
        InetAddress target = InetAddress.getByAddress(new byte[] { (byte) 192, (byte) 168, (byte) 0,
        		(byte) 5});
        
        new ARPSender(devices[4], target).start();
        
        System.out.println();
        System.out.println("======================== ARP packet========================");  
        for (int i = 0; i < 5; i++) { // 包的数量为 15  
            ...
            System.out.println("Src MAC: " + sourceAddress);  
            System.out.println("Des MAC: " + destinationAddress);  
...
//          System.out.println("\n");  
    ...
    public static void openDevice() throws Exception {  
         ...
         *  第四个参数：超时 
         */  
        captor = JpcapCaptor.openDevice(devices[4], 65535, true, 2000);  
    }  
